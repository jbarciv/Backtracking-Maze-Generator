...
\lstset{style=mystyle}
%también se puede poner [firstnumber=39]
\begin{lstlisting}[language=C++, title=Macro planteada para sustituir el ajuste de dimensiones, frame=single, numbers=none]
