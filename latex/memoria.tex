...
En la figura \# puede verse la commparación entre la salida por consola mediante el símbolo \textsc{ascii} \# y el utilizado en el código anterior \textsc{unicode}.
